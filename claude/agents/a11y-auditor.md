...
1. **BEFORE**: read `.agents/memory/a11y-auditor/MEMORY.md` (recurring patterns, quirks, past findings) **and**, for user-facing surfaces, the design-system source — `docs/design-system/governance.md`, `state-matrix.md`, `fidelity-matrix.md` — so Axis B has its reference.
